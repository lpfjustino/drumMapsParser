 ...
 */
public enum NiAbbeyRoad60sEarly {
    
 
    KICK_DAMPENED("Kick Felt Beater", 60, EnumPieceType.KICK),
    KICK_HALF_OPEN("Kick Rubber Beater", 36, EnumPieceType.KICK),
    ...
    TOM_1_CENTER_RIGHT("Tom 1 Center Right", 93, EnumPieceType.TOM),
    TOM_1_CENTER_LEFT("Tom 1 Center Left", 95, EnumPieceType.TOM),
    ...
    TOM_1_RIM_ONLY("Tom 1 Rim Only", 74, EnumPieceType.TOM),
    
    FLOOR_TOM_CENTER_RIGHT("Floor Tom Center Right", 89, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_CENTER_LEFT("Floor Tom Center Left", 88, EnumPieceType.FLOOR_TOM),
    ...
    SIZZLE_RIDE_TIP("Sizzle Ride Tip", 57, EnumPieceType.RIDE),
    SIZZLE_RIDE_BELL("Sizzle Ride Bell", 59, EnumPieceType.RIDE),
    SIZZLE_RIDE_EDGE("Sizzle Ride Edge", 58, EnumPieceType.RIDE),
    ...
    NiAbbeyRoad60sEarly (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.NI_ABBEY_ROAD_60S_EARLY.name();
    }
