 ...
 */
public enum NiAbbeyRoad50sSpringBrushes {
    
    KICK_DAMPENED("Kick Dampened", 36, EnumPieceType.KICK),
    KICK_HALF_OPEN("Kick Open", 60, EnumPieceType.KICK),
    ...
    FLOOR_TOM_BRUSH_TAP("Floor Tom Brush Tap", 45, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_BRUSH_DIG("Floor Tom Brush Dig", 47, EnumPieceType.FLOOR_TOM),
    ...
    PERCUSSION_COWBELL("Cowbell Hit", 29, EnumPieceType.PERCUSSION),
    PERCUSSION_BONGO_LOW("Bongo Low", 26, EnumPieceType.PERCUSSION),
    PERCUSSION_BONGO_HIGH_MUTED("Bongo High Muted", 27, EnumPieceType.PERCUSSION),
    PERCUSSION_BONGO_HIGH_OPEN("Bongo High Open", 28, EnumPieceType.PERCUSSION);
    
    public int note;
    public String name;
    public EnumPieceType type;

    NiAbbeyRoad50sSpringBrushes (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.NI_ABBEY_ROAD_50S_SPRING_BRUSHES.name();
    }
