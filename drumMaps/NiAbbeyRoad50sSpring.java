 ...
 */
public enum NiAbbeyRoad50sSpring {
    ...
    TOM_1_CENTER_ALTERNATING("Tom 1 Center L/R Alternating", 45, EnumPieceType.TOM),
    TOM_1_RIMSHOT("Tom 1 Rimshot", 69, EnumPieceType.TOM),
    TOM_1_RIM_ONLY("Tom 1 Rim Only", 73, EnumPieceType.TOM),
    TOM_1_BRUSH_TAP("Tom 1 Brush Tap", 91, EnumPieceType.TOM),
    TOM_1_BRUSH_DIG("Tom 1 Brush Dig", 93, EnumPieceType.TOM),
    ...
    FLOOR_TOM_CENTER_ALTERNATING("Floor Tom Center L/R Alternating", 41, EnumPieceType.FLOOR_TOM),
    ...
    FLOOR_TOM_BRUSH_TAP("Floor Tom Brush Tap", 88, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_BRUSH_DIG("Floor Tom Brush Dig", 89, EnumPieceType.FLOOR_TOM),
    ...
    NiAbbeyRoad50sSpring (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.NI_ABBEY_ROAD_50S_SPRING.name();
    }
