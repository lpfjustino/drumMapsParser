 ...
 */
public enum NiAbbeyRoad60sLate {
    ...
    TOM_1_TOWEL("Tom 1 Rimshot", 107, EnumPieceType.TOM),
    ...
    TOM_2_TOWEL("Tom 2 Rimshot", 105, EnumPieceType.TOM),
    ...
    FLOOR_TOM_TOWEL("Floor Tom Rimshot", 103, EnumPieceType.FLOOR_TOM),
    ...
    NiAbbeyRoad60sLate (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.NI_ABBEY_ROAD_60S_LATE.name();
    }
