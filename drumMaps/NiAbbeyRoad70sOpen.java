 ...
 */
public enum NiAbbeyRoad70sOpen {
    
    KICK_DAMPENED("Kick Dampened", 36, EnumPieceType.KICK),
    KICK_HALF_OPEN("Kick Half Open", 82, EnumPieceType.KICK),
    ...
    FLOOR_TOM_1_CENTER_RIGHT("Floor Tom 1 Center Right", 100, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_1_CENTER_LEFT("Floor Tom 1 Center Left", 98, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_1_CENTER_ALTERNATING("Floor Tom 1 Center L/R Alternating", 87, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_1_RIMSHOT("Floor Tom 1 Rimshot", 71, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_1_RIM_ONLY("Floor Tom 1 Rim Only", 75, EnumPieceType.FLOOR_TOM),
    
    FLOOR_TOM_2_CENTER_RIGHT("Floor Tom 2 Center Right", 96, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_2_CENTER_LEFT("Floor Tom 2 Center Left", 95, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_2_CENTER_ALTERNATING("Floor Tom 2 Center L/R Alternating", 45, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_2_RIMSHOT("Floor Tom 2 Rimshot", 69, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_2_RIM_ONLY("Floor Tom 2 Rim Only", 74, EnumPieceType.FLOOR_TOM),
    ...
    CRASH_2_CHOKE("Crash 2 Choke", 23, EnumPieceType.CRASH),
    ...
    RIDE_CHOKE("Ride Choke", 24, EnumPieceType.RIDE),
    
    SIZZLE_RIDE_TIP("Sizzle Ride Tip", 58, EnumPieceType.RIDE),
    SIZZLE_RIDE_BELL("Sizzle Ride Bell", 59, EnumPieceType.RIDE),
    SIZZLE_RIDE_EDGE("Sizzle Ride Edge", 57, EnumPieceType.RIDE),
    SIZZLE_RIDE_CHOKE("Sizzle Ride Choke", 25, EnumPieceType.RIDE),
    ...
    PERCUSSION_COWBELL_HIGH_OPEN("Cowbell High Open", 29, EnumPieceType.PERCUSSION),
    PERCUSSION_COWBELL_HIGH_CLOSED("Cowbell High Closed", 30, EnumPieceType.PERCUSSION),
    PERCUSSION_COWBELL_LOW_OPEN("Cowbell Low Open", 27, EnumPieceType.PERCUSSION),
    PERCUSSION_COWBELL_LOW_CLOSED("Cowbell Low Closed", 28, EnumPieceType.PERCUSSION),
    PERCUSSION_SHAKER_SHAKE("Shaker shake", 26, EnumPieceType.PERCUSSION);
    
    public int note;
    public String name;
    public EnumPieceType type;

    NiAbbeyRoad70sOpen (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.NI_ABBEY_ROAD_70S_OPEN.name();
    }
