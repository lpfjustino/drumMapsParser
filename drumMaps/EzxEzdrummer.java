...
public enum EzxEzdrummer {
    ...
    CRASH_A("Crash Cymbal A", 49, EnumPieceType.CRASH),
    CRASH_B("Crash Cymbal B", 54, EnumPieceType.CRASH),
    CRASH_B_MUTED("Crash Cymbal B Muted", 57, EnumPieceType.CRASH),   
    RIDE_EDGE("Ride Cymbal Edge", 58, EnumPieceType.RIDE),
    RIDE_BOW("Ride Cymbal Bow", 51, EnumPieceType.RIDE),
    RIDE_BELL("Ride Cymbal Bell", 53, EnumPieceType.RIDE),
    COWBELL("Cowbell", 38, EnumPieceType.PERCUSSION),
    ...
    EzxEzdrummer (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.EZX_EZDRUMMER.name();
    }
}
