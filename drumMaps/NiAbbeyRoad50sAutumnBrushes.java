 ...
 */
public enum NiAbbeyRoad50sAutumnBrushes {
    ...
    SNARE_ALTERNATING("Snare L/R Alternating", 81, EnumPieceType.SNARE),
    ...
    SNARE_HALFWAY_ALTERNATING("Snare Halfway L/R Alternating", 83, EnumPieceType.SNARE),
    SNARE_RIMSHOT("Snare Rimshot", 84, EnumPieceType.SNARE),
    SNARE_SIDESTICK("Snare Sidestick", 37, EnumPieceType.SNARE),
    SNARE_FLAM("Snare Flam", 86, EnumPieceType.SNARE),
    ...
    SNARE_BRUSH_TAP_LEFT("Snare Brush Tap Left Hand", 38, EnumPieceType.SNARE),
    SNARE_BRUSH_TAP_RIGHT("Snare Brush Tap Right Hand", 40, EnumPieceType.SNARE),
    SNARE_BRUSH_DIG_IN("Snare Brush Dig In", 39, EnumPieceType.SNARE),
    SNARE_BRUSH_SWISH("Snare Brush Swish", 37, EnumPieceType.SNARE),
    ...
    HIHAT_BRUSH_OPEN("HiHat Brush Open", 98, EnumPieceType.HIHAT_OPEN),
    HIHAT_BRUSH_CLOSED_TIP("HiHat Brush Closed Tip", 100, EnumPieceType.HIHAT_CLOSED),
    HIHAT_BRUSH_OPEN_HALF("HiHat Brush Open 1/2", 46, EnumPieceType.HIHAT_OPEN),
    
    TOM_1_CENTER_RIGHT("Tom 1 Center Right", 112, EnumPieceType.TOM),
    TOM_1_CENTER_LEFT("Tom 1 Center Left", 113, EnumPieceType.TOM),
    TOM_1_CENTER_ALTERNATING("Tom 1 Center L/R Alternating", 91, EnumPieceType.TOM),
    TOM_1_RIMSHOT("Tom 1 Rimshot", 69, EnumPieceType.TOM),
    TOM_1_RIM_ONLY("Tom 1 Rim Only", 73, EnumPieceType.TOM),
    TOM_1_BRUSH_TAP("Tom 1 Brush Tap", 48, EnumPieceType.TOM),
    TOM_1_BRUSH_DIG("Tom 1 Brush Dig", 50, EnumPieceType.TOM),
    
    TOM_2_CENTER_RIGHT("Tom 2 Center Right", 110, EnumPieceType.TOM),
    TOM_2_CENTER_LEFT("Tom 2 Center Left", 108, EnumPieceType.TOM),
    TOM_2_CENTER_ALTERNATING("Tom 2 Center L/R Alternating", 88, EnumPieceType.TOM),
    TOM_2_RIMSHOT("Tom 2 Rimshot", 67, EnumPieceType.TOM),
    TOM_2_RIM_ONLY("Tom 2 Rim Only", 74, EnumPieceType.TOM),
    TOM_2_BRUSH_TAP("Tom 2 Brush Tap", 45, EnumPieceType.TOM),
    TOM_2_BRUSH_DIG("Tom 2 Brush Dig", 47, EnumPieceType.TOM),
    
    FLOOR_TOM_CENTER_RIGHT("Floor Tom Center Right", 110, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_CENTER_LEFT("Floor Tom Center Left", 108, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_CENTER_ALTERNATING("Floor Tom Center L/R Alternating", 88, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_RIMSHOT("Floor Tom Rimshot", 65, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_RIM_ONLY("Floor Tom Rim Only", 72, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_BRUSH_TAP("Floor Tom Brush Tap", 41, EnumPieceType.FLOOR_TOM),
    FLOOR_TOM_BRUSH_DIG("Floor Tom Brush Dig", 43, EnumPieceType.FLOOR_TOM),
    ...
    CRASH_1_BRUSH("Crash 1 Brush", 49, EnumPieceType.CRASH),
    ...
    CRASH_2_BRUSH("Crash 2 Brush", 51, EnumPieceType.CRASH),
    ...
    RIDE_BRUSH_TIP("Ride Brush Tip", 52, EnumPieceType.RIDE),
    RIDE_BRUSH_SWEEP("Ride Brush Sweep", 53, EnumPieceType.RIDE),
    ...
    NiAbbeyRoad50sAutumnBrushes (String valName, int valNote, EnumPieceType valType){
        name = valName;
        note = valNote;
        type = valType;
    }
    ...
    public static String getMapVst(){
        return EnumVstList.NI_ABBEY_ROAD_50S_AUTUMN_BRUSHES.name();
    }
